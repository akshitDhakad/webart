  ...
  return (
    <main className="about relative">
      <Layout>
        ...
        <section className="">
          <div
            className="abosolute m-1 overflow-hidden top-0 h-screen flex items-center justify-center rounded-2xl"
            style={backgroundImg}
          >
            <div className="absolute bg-violet-800 opacity-20 h-full w-full"></div>
